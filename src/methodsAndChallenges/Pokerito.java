...
public class Pokerito {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 1; i <= 5; i++) {
            String start2 = readInput.nextLine();
            String dealerCards = randomCard();

            System.out.println("Card " + i + dealerCards);
            if (userCard.equals(dealerCards)) {
                userMatches += 1;
            }
            if (computerCard.equals(dealerCards)) {
                computerMatches += 1;
            }
        }
